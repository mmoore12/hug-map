...
exports.world_merc = {
	...
	availableStyles: ['default', 'blue_lines', 'red_lines']
};
...
exports.hugpoints = {
	...
	datasource: {
		type: 'shape',
		file: config.geodataDirectory + '/HUGPoints/HUGPoints.shp'
		
	},
	availableStyles: ['HUGPoints_default']
};
...
exports.hugareas = {
	...
	datasource: {
		type: 'shape',
		file: config.geodataDirectory + '/HUGAreas/HUGAreas.shp'
		
	},
	availableStyles: ['HUGAreas_default']
};
...
exports.instamap = {
	...
	datasource: {
		type: 'geojson',
		file: config.geodataDirectory + '/instamap/instamap.json'
	},
...
exports.test = {
	...
	datasource: {
		type: 'shape',
		file: config.geodataDirectory + '/Test/TestPoints.shp'
